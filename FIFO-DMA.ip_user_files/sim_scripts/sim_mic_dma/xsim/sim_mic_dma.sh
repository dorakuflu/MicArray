...
#
# Script generated by Vivado on Wed May 28 19:06:54 -0400 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sim_mic_dma.sh
...
#
# Usage        : sim_mic_dma.sh
#                sim_mic_dma.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sim_mic_dma.sh [-reset_run]
#                sim_mic_dma.sh [-reset_log]
#                sim_mic_dma.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_20 -L smartconnect_v1_0 -L processing_system7_vip_v1_0_22 -L xilinx_vip"

# script info
echo -e "sim_mic_dma.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sim_mic_dma.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_16 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sim_mic_dma xil_defaultlib.sim_mic_dma xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sim_mic_dma -key {Behavioral:sim_1:Functional:sim_mic_dma} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5a83.protoinst" -protoinst "protoinst_files/sim_mic_dma.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sim_mic_dma.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sim_mic_dma.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sim_mic_dma.sh [-help]\n\
Usage: sim_mic_dma.sh [-step]\n\
Usage: sim_mic_dma.sh [-lib_map_path]\n\
Usage: sim_mic_dma.sh [-reset_run]\n\
Usage: sim_mic_dma.sh [-reset_log]\n\
Usage: sim_mic_dma.sh [-keep_index]\n\
Usage: sim_mic_dma.sh [-noclean_files]\n\n\
