...
#
# Script generated by Vivado on Fri May 30 17:06:52 -0400 2025
...
# set xvlog options
xvlog_opts="--incr --relax  -L xilinx_vip"
...
simulate()
{
  xsim sim_mic_dma -key {Behavioral:sim_1:Functional:sim_mic_dma} -tclbatch cmd.tcl -protoinst "protoinst_files/sim_mic_dma.protoinst" -log simulate.log
}
