...
#
# Script generated by Vivado on Mon Jul 21 16:44:06 -0400 2025
...
#
# Usage        : PDM_to_PCM.sh
#                PDM_to_PCM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PDM_to_PCM.sh [-reset_run]
#                PDM_to_PCM.sh [-reset_log]
#                PDM_to_PCM.sh [-help]
#
...
# script info
echo -e "PDM_to_PCM.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PDM_to_PCM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L cic_compiler_v4_0_21 -L xbip_pipe_v3_0_10 -L fir_compiler_v7_2_24 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PDM_to_PCM xil_defaultlib.PDM_to_PCM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PDM_to_PCM -key {Behavioral:sim_1:Functional:PDM_to_PCM} -tclbatch cmd.tcl -protoinst "protoinst_files/PDM_to_PCM.protoinst" -protoinst "protoinst_files/bd_5a83.protoinst" -protoinst "protoinst_files/bd_8523.protoinst" -protoinst "protoinst_files/bd_3885.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PDM_to_PCM.wdb xsim.dir libdpi.so)
...
Usage: PDM_to_PCM.sh [-step]\n\
Usage: PDM_to_PCM.sh [-lib_map_path]\n\
Usage: PDM_to_PCM.sh [-reset_run]\n\
Usage: PDM_to_PCM.sh [-reset_log]\n\
Usage: PDM_to_PCM.sh [-keep_index]\n\
