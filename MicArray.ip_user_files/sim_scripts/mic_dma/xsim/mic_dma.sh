...
#
# Script generated by Vivado on Wed May 28 17:47:34 -0400 2025
...
#
# Usage        : mic_dma.sh
#                mic_dma.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mic_dma.sh [-reset_run]
#                mic_dma.sh [-reset_log]
#                mic_dma.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_20 -L smartconnect_v1_0 -L processing_system7_vip_v1_0_22 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "mic_dma.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mic_dma.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_20 -L processing_system7_vip_v1_0_22 -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_12 -L lib_fifo_v1_0_21 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_36 -L axi_sg_v4_1_20 -L axi_dma_v7_1_35 -L xlconstant_v1_1_9 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_34 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_16 -L generic_baseblocks_v2_1_2 -L axi_data_fifo_v2_1_34 -L axi_protocol_converter_v2_1_35 -L axi_clock_converter_v2_1_33 -L blk_mem_gen_v8_4_10 -L axi_dwidth_converter_v2_1_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mic_dma xil_defaultlib.mic_dma xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mic_dma -key {Behavioral:sim_1:Functional:mic_dma} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5a83.protoinst" -protoinst "protoinst_files/mic_dma.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mic_dma.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mic_dma.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mic_dma.sh [-help]\n\
Usage: mic_dma.sh [-step]\n\
Usage: mic_dma.sh [-lib_map_path]\n\
Usage: mic_dma.sh [-reset_run]\n\
Usage: mic_dma.sh [-reset_log]\n\
Usage: mic_dma.sh [-keep_index]\n\
Usage: mic_dma.sh [-noclean_files]\n\n\
