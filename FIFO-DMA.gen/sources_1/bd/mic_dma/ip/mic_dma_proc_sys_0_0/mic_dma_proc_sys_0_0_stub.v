...
/* synthesis syn_black_box black_box_pad_pin="sys_clk,resetn,pdm_clk,SW,BTN,led_cnt[2:0],mic_array[0:0],proc_mic_array[63:0],ready_mic_array,valid_mic_array" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 pdm_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME pdm_clk, FREQ_HZ 3840000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0" *) input pdm_clk;
  input SW;
  input BTN;
  output [2:0]led_cnt;
  input [0:0]mic_array;
