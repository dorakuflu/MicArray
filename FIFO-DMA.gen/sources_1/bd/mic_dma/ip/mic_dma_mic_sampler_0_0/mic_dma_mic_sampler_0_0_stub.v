...
//               c:/Users/kuflu/Vivado/Research/FIFO-DMA/FIFO-DMA.gen/sources_1/bd/mic_dma/ip/mic_dma_mic_sampler_0_0/mic_dma_mic_sampler_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "mic_dma_mic_sampler_0_0,mic_sampler,{}" *) (* CORE_GENERATION_INFO = "mic_dma_mic_sampler_0_0,mic_sampler,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=mic_sampler,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,PACKET_SIZE=20,DATA_WIDTH=32,BUS_WIDTH=64,MIC_NUM=2}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "mic_sampler,Vivado 2025.1" *) 
module mic_dma_mic_sampler_0_0(s_axis_aclk, s_axis_aresetn, mic_data_in, 
  mic_ready_in, mic_valid_in, m_axis_tready, m_axis_tvalid, m_axis_tdata, m_axis_tlast)
/* synthesis syn_black_box black_box_pad_pin="s_axis_aresetn,mic_data_in[63:0],mic_ready_in,mic_valid_in,m_axis_tready,m_axis_tvalid,m_axis_tdata[63:0],m_axis_tlast" */
