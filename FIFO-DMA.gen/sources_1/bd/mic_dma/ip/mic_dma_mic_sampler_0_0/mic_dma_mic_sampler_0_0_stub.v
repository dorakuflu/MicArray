...
(* CHECK_LICENSE_TYPE = "mic_dma_mic_sampler_0_0,mic_sampler,{}" *) (* CORE_GENERATION_INFO = "mic_dma_mic_sampler_0_0,mic_sampler,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=mic_sampler,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,DATA_WIDTH=32,BUS_WIDTH=32,MIC_NUM=100}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
/* synthesis syn_black_box black_box_pad_pin="s_axis_aresetn,m_axis_tready,m_axis_tvalid,m_axis_tdata[31:0],m_axis_tlast" */
