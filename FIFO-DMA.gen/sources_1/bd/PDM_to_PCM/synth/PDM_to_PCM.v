...
(* CORE_GENERATION_INFO = "PDM_to_PCM,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PDM_to_PCM,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "PDM_to_PCM.hwdef" *) 
module PDM_to_PCM
   (BTN,
    SW,
    clk_100MHz,
  ...
  PDM_to_PCM_PDM_reader_0_0 PDM_reader_0
       (.SW(SW),
        ...
        .resetn(resetn));
  PDM_to_PCM_amplify_0_0 amplify_0
       (.BTN(BTN),
        .clk(clk_100MHz),
