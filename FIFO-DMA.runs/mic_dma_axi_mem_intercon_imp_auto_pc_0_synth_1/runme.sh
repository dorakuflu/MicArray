...
HD_PWD='C:/Users/kuflu/Vivado/Research/FIFO-DMA/FIFO-DMA.runs/mic_dma_axi_mem_intercon_imp_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mic_dma_axi_mem_intercon_imp_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mic_dma_axi_mem_intercon_imp_auto_pc_0.tcl
