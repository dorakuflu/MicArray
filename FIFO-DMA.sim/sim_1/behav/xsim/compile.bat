...
REM
REM Generated by Vivado on Fri May 30 17:06:57 -0400 2025
...
echo "xvlog --incr --relax -L xilinx_vip -prj tb_mic_sampler_vlog.prj"
call xvlog  --incr --relax -L xilinx_vip -prj tb_mic_sampler_vlog.prj -log xvlog.log
