...
// Target Devices: 
// Tool Versions: 
// Description: Samples a microphone pair through a single PDM pin from the GPIO.
// 
// Dependencies: 
// 
// Revision:
...
module PDM_reader (
    ...
    input wire  clk_pdm,    // PDM Clock, also outputted over GPIO
    ...
    // 4-cycle delay for PDM clock propagation
    // 1 cycle from FSM transition + 3 cycles from counter 
    ...
    // Send when samples from both mics are collected
