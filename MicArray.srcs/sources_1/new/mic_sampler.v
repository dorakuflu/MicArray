...
// Target Devices: 
// Tool Versions: 
// Description: Packages raw audio data from the conversion pipeline and sends them 
//              to the FIFO to queue before transferring over the DMA.
// 
// Dependencies: 
// 
// Revision:
...
module mic_sampler #(
    ...
    localparam CYCLES = (MIC_NUM*DATA_WIDTH + BUS_WIDTH - 1) / BUS_WIDTH;
