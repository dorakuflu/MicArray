...
HD_PWD='C:/Users/dkuflu/Research/FIFO-DMA/FIFO-DMA.runs/mic_dma_ila_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mic_dma_ila_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mic_dma_ila_axi_smc_0.tcl
