...
HD_PWD='C:/Users/kuflu/Vivado/Research/FIFO-DMA/FIFO-DMA.runs/PDM_to_PCM_cic_compiler_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PDM_to_PCM_cic_compiler_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PDM_to_PCM_cic_compiler_1_0.tcl
